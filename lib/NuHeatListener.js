...
module.exports = class NuHeatListener {
    ...
    connect(){
        ...
        this.connection.onreconnecting((error) => {
            this.log.debug('Notification listener reconnecting: ' + (error?.message || 'unknown error'));
        });
        ...
        this.connection.onclose((error) => {
            this.log.debug('Notification listener closed: ' + (error?.message || 'normal shutdown'));
        });
